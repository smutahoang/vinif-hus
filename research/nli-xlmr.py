...
class NliXlmrClassifier:
    ...
    def __init__(self, trained_model_path: str,idx_to_label:dict, device='cpu') -> None:
        ...
        if not os.path.exists(trained_model_path):
            ...
            output = 'NLI_XLMR_100Epoch_full.bk'
            gdown.download(url, output, quiet=False)
            trained_model_path = 'NLI_XLMR_100Epoch_full.bk'
        ...
        self.model = XLMRobertaForSequenceClassification(config=xlmr_config)
...
if __name__ == '__main__':
    ...
    nli_xlmr_classifier = NliXlmrClassifier(r'/home/hoang/qnt/NLI_XLMR_100Epoch_full.bk',idx_to_label,device='cuda')
